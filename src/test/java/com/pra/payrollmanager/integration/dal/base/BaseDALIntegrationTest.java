package com.pra.payrollmanager.integration.dal.base;
 ...
 * @param <DAO> : dao class for entity
 * @param <DAL> : dal class for entity
 */
@SpringBootTest
@TestInstance(value = Lifecycle.PER_CLASS)
public abstract class BaseDALIntegrationTest<
    DAO extends BaseDAO<?>, DAL extends BaseDAL<?, DAO, ?>> {

  @Autowired protected DAL dalService;
