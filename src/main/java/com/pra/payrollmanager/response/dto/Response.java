...
public class Response<T> {
	...
	public static class TypedResponseBuilder<T> {
		...
		public TypedResponseBuilder<T> addErrorMsg(String errorMsg) {
			if (this.errors == null) {
				this.errors = new ArrayList<>();
			}
			this.errors.add(ResponseError.builder()
	...
	public static class ResponseBuilder {
		...
		public ResponseBuilder addErrorMsg(String errorMsg) {
			if (this.errors == null) {
				this.errors = new ArrayList<>();
			}
			this.errors.add(ResponseError.builder()
		...
		public ResponseBuilder validationException() {
			this.status = ResponseStatus.VALIDATION_ERROR;
			return this;
		}
